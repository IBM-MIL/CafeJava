...
public class JavaPresidentAdapterResource {
	...
	static Logger logger = Logger.getLogger(JavaPresidentAdapterResource.class.getName());

    //Define the server api to be able to perform server operations
    WLServerAPI api = WLServerAPIProvider.getWLServerAPI();

	/* Path for method: "<server address>/MFPFSampleProject/adapters/JavaPresidentAdapter/users" */
	@GET
	...
	/* Path for method: "<server address>/MFPFSampleProject/adapters/JavaPresidentAdapter/users/{username}" */
	@GET
	@Path("/{username}")
	...
	/* Path for method: "<server address>/MFPFSampleProject/adapters/JavaPresidentAdapter/users/helloUserQuery?name=value" */
	@GET
	@Path("/helloUserQuery")
	...
	/* Path for method: "<server address>/MFPFSampleProject/adapters/JavaPresidentAdapter/prop" */
	@GET
	@Path("/prop")
	...
	/* Path for method: "<server address>/MFPFSampleProject/adapters/JavaPresidentAdapter/users/{first}/{middle}/{last}?age=value" */
	@POST
	...
	/* Path for method: "<server address>/MFPFSampleProject/adapters/JavaPresidentAdapter/users/newUsers" */
	@PUT
	@Path("/newUsers")
